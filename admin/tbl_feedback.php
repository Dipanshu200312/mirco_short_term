...
if (isset($_GET['id'])) {
    ...
    $feedback_id = filter_var($_GET['id'], FILTER_SANITIZE_NUMBER_INT);

    // Assuming you have a query to delete the speaker based on the ID
    $sql = "DELETE FROM feedback_form2 WHERE id = $feedback_id";
...
<body>
    ...
    include 'partials/page-title.php'; ?>
                ...
                <a href='feedback_form2.php?id=" . $row["id"] . "' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this feedback?\");'>Delete</a>
            </td>
