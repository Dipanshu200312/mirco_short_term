        ...
        <div class="d-flex align-items-center gap-1">
            ...
            <div class="logo-topbar">
                ...
                <a href="index.php" class="logo-light">
                    <span class="logo-lg">
                        <img src="https://www.aafmindia.co.in/personal-wealth-management-course/img/AAFM_logo.png" alt="logo">
                    </span>
                    <span class="logo-sm">
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="assets/images/users/" class="img-fluid rounded-circle"
                                                alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#" role="button"
                    ...
                    <span class="d-lg-block d-none">
                        <h5 class="my-0 fw-normal"><?php echo $_SESSION['admin_name'] ?> <i
